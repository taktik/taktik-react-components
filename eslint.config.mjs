 ...
 *
 * Beside the Vitest suite (`npm test`), the two rules that read a hook's dependency arrays are the
 * only automated check anything here gets. Both are errors: the
