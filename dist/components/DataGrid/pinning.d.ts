...
export declare const FROZEN_LEFT_CLASS = "rdg-cell-frozen-left";
/** What the grid's own leading column (the selection checkbox, the expander toggle) declares. */
export declare const leadingColumnPinning: {
    readonly frozen: false;
    readonly frozenLeft: true;
    readonly cellClass: "rdg-cell-frozen-left";
    readonly headerCellClass: "rdg-cell-frozen-left";
};
