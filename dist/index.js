...
import Ie, { createContext as bt, memo as We, forwardRef as yn, useContext as ke, useMemo as B, useCallback as J, useRef as ve, useEffect as Ge, useState as Q, useImperativeHandle as Go, useLayoutEffect as _o, useId as Bo } from "react";
import { flushSync as Ft } from "react-dom";
import De from "@emotion/styled";
...
function ia({
  ...
  if (y(u) && (k(t), P < l && M()), n === "CHANGE_ROW" && (v === E ? P === w || (v = 0, P += 1) : v === -1 && (P === c || (P -= 1, v = E - 1), k(!1))), P < l) {
    let x = r[v].parent;
    const S = P;
    for (P = l; x !== void 0; ) {
      const N = D(x);
      N >= S && (P = N, v = x.idx), x = x.parent;
    }
  }
  return {
    idx: v,
...
const Er = /* @__PURE__ */ bt(void 0), Mr = Er.Provider, Pr = /* @__PURE__ */ bt(void 0), Da = Pr.Provider;
function Or() {
  const e = ke(Er), t = ke(Pr);
...
function Na({
  ...
  const i = (t == null ? void 0 : t.width) ?? Pa, s = (t == null ? void 0 : t.minWidth) ?? Oa, c = (t == null ? void 0 : t.maxWidth) ?? void 0, l = (t == null ? void 0 : t.renderCell) ?? va, w = (t == null ? void 0 : t.sortable) ?? !1, h = (t == null ? void 0 : t.resizable) ?? !1, d = (t == null ? void 0 : t.draggable) ?? !1, {
    columns: u,
    colSpanColumns: g,
    ...
    for (const Y of u) {
      let L = n(Y);
      typeof L == "number" ? L = Rr(L, Y) : L = Y.minWidth, T.push(`${L}px`), x.set(Y, {
        width: L,
        left: S
      }), S += L;
    }
    ...
    for (let Y = 0; Y <= y; Y++) {
      const L = u[Y];
      z[`--rdg-frozen-left-${L.idx}`] = `${x.get(L).left}px`;
    }
    return {
      templateColumns: T,
      layoutCssVars: z,
    ...
    if (!a)
      return [0, u.length - 1];
    const x = o + k, S = o + r, N = u.length - 1, T = wt(y + 1, N);
    if (x >= S)
      return [T, T];
    let z = T;
    for (; z < N; ) {
...
function Fa(e, t, n, r, o, a, i, s, c, l) {
  const w = ve(o), h = e.length === t.length, d = h && o !== w.current, u = [...n], g = [];
  for (const {
    key: E,
    idx: k,
    width: D
  } of t)
    typeof D == "string" && (d || !i.has(E)) && !a.has(E) && (u[k] = D, g.push(E));
  const y = u.join(" ");
  tt(() => {
    w.current = o, v(g);
  });
  function v(E) {
    E.length !== 0 && c((k) => {
      ...
      for (const $ of E) {
        const x = Zn(r, $);
        M || (M = x !== k.get($)), x === void 0 ? D.delete($) : D.set($, x);
      }
      return M ? D : k;
    });
  }
  function P(E, k) {
    ...
    for (const {
      ...
      if (D === S) {
        ...
        M[N] = z;
      } else h && typeof T == "string" && !a.has(S) && (M[N] = T, $.push(S));
    r.current.style.gridTemplateColumns = M.join(" ");
    const x = typeof k == "number" ? k : Zn(r, D);
    Ft(() => {
      s((S) => {
        const N = new Map(S);
        return N.set(D, x), N;
...
function Ha() {
  const e = ve(null), [t, n] = Q(1), [r, o] = Q(1), [a, i] = Q(0);
  return tt(() => {
    const {
      ResizeObserver: s
    } = window;
    ...
    const {
      ...
      width: d,
      height: u
    } = e.current.getBoundingClientRect(), g = h - l, y = d - w + c, v = u - g;
    n(y), o(v), i(g);
    const P = new s((E) => {
      const k = E[0].contentBoxSize[0], {
        clientHeight: D,
        offsetHeight: M
      } = e.current;
      Ft(() => {
        n(k.inlineSize), o(k.blockSize), i(M - D);
      });
    });
...
function La({
  ...
  const w = B(() => {
    if (a === 0) return 0;
    let h = a;
    const d = (u, g) => g !== void 0 && u + g > a ? (h = u, !0) : !1;
    for (const u of t) {
      const g = u.idx;
      if (g >= h || d(g, ge(u, s, {
        type: "HEADER"
...
function Wa({
  ...
  const {
    ...
    const g = e.map((v) => {
      ...
      return u += `${P}px `, d += P, E;
    }), y = (v) => Lt(0, wt(e.length - 1, v));
    return {
      totalRowHeight: d,
      gridTemplateRows: u,
      getRowTop: (v) => g[y(v)].top,
      getRowHeight: (v) => g[y(v)].height,
      findRowIdx(v) {
        let P = 0, E = g.length - 1;
        for (; P <= E; ) {
          const k = P + Vn((E - P) / 2), D = g[k].top;
          if (D === v) return k;
          if (D < v ? P = k + 1 : D > v && (E = k - 1), P > E) return E;
        }
        return 0;
      }
    };
  }, [t, e]);
  let w = 0, h = e.length - 1;
  if (o) {
    const u = l(r), g = l(r + n);
    w = Lt(0, u - 4), h = wt(e.length - 1, g + 4);
  }
  return {
...
function Aa({
  ...
  function v(M) {
    if (M.preventDefault(), M.buttons !== 1) return;
    d(!0), window.addEventListener("mouseover", $), window.addEventListener("mouseup", x);
    function $(S) {
      S.buttons !== 1 && x();
    }
    function x() {
      window.removeEventListener("mouseover", $), window.removeEventListener("mouseup", x), d(!1), P();
    }
  }
  function P() {
    const M = s.current;
    if (M === void 0) return;
    const $ = y < M ? y + 1 : M, x = y < M ? M + 1 : y;
    k($, x), u(void 0);
  }
  function E(M) {
    M.stopPropagation(), k(y + 1, t.length);
  }
  function k(M, $) {
    const x = t[y], S = [...t], N = [];
    for (let T = M; T < $; T++)
  ...
  function D() {
    var T;
    const M = ((T = n.colSpan) == null ? void 0 : T.call(n, {
      type: "ROW",
      row: t[y]
    })) ?? 1, {
      insetInlineStart: $,
      ...x
    } = nt(n, M), S = "calc(var(--rdg-drag-handle-size) * -0.5 + 1px)", N = n.idx + M - 1 === o;
    return {
      ...x,
      gridRowStart: e,
...
function _a({
  ...
  var P, E, k;
  const c = ve(void 0), l = ((P = e.editorOptions) == null ? void 0 : P.commitOnOutsideClick) !== !1, w = ce(() => {
    u(!0, !1);
  });
  Ge(() => {
    if (!l) return;
  ...
  const {
    cellClass: y
  } = e, v = Ct(e, "rdg-editor-container", typeof y == "function" ? y(n) : y, !((E = e.editorOptions) != null && E.displayCellContent) && Ga);
  return /* @__PURE__ */ b("div", {
    role: "gridcell",
...
function Lr({
  ...
  return e.sortable ? /* @__PURE__ */ b(Xa, {
    sortDirection: t,
    priority: n,
    children: e.name
  }) : e.name;
...
const qa = "c6l2wv17-0-0-beta-47", Va = "c1kqdw7y7-0-0-beta-47", Za = `rdg-cell-resizable ${Va}`, Qa = "r1y6ywlx7-0-0-beta-47", Ja = "rdg-cell-draggable", ei = "c1bezg5o7-0-0-beta-47", ti = `rdg-cell-dragging ${ei}`, ni = "c1vc96037-0-0-beta-47", ri = `rdg-cell-drag-over ${ni}`;
function oi({
  column: e,
  colSpan: t,
  rowIdx: n,
  ...
  const [d, u] = Q(!1), [g, y] = Q(!1), v = w === "rtl", P = Ir(e, n), {
    tabIndex: E,
    childTabIndex: k,
    onFocus: D
  } = xt(r), M = i == null ? void 0 : i.findIndex((p) => p.columnKey === e.key), $ = M !== void 0 && M > -1 ? i[M] : void 0, x = $ == null ? void 0 : $.direction, S = $ !== void 0 && i.length > 1 ? M + 1 : void 0, N = x && !S ? x === "ASC" ? "ascending" : "descending" : void 0, {
    sortable: T,
    resizable: z,
    draggable: Y
  } = e, L = Ct(e, e.headerCellClass, T && qa, z && Za, Y && Ja, d && ti, g && ri), V = e.renderHeaderCell ?? Lr;
  function A(p) {
    ...
    const {
      ...
      right: te,
      left: le
    } = j.getBoundingClientRect(), we = v ? p.clientX - le : te - p.clientX;
    let ie = !1;
    function be(ye) {
      const {
        width: de,
      ...
      let Be = v ? rt + we - ye.clientX : ye.clientX + we - ze;
    ...
    function Re(ye) {
      ie || be(ye), W.removeEventListener("pointermove", be), W.removeEventListener("dblclick", Ce), W.removeEventListener("lostpointercapture", Re);
    }
    W.setPointerCapture(_), W.addEventListener("pointermove", be), W.addEventListener("dblclick", Ce), W.addEventListener("lostpointercapture", Re);
  }
  function re(p) {
    if (s == null) return;
    const {
    ...
    if ($ === void 0) {
      ...
      let _;
      if ((W === !0 && x === "DESC" || W !== !0 && x === "ASC") && (_ = {
        columnKey: e.key,
        direction: x === "ASC" ? "DESC" : "ASC"
      }), p) {
        const j = [...i];
        _ ? j[M] = _ : j.splice(M, 1), s(j);
      } else
        s(_ ? [_] : []);
    }
  }
  ...
  function Me(p) {
    p.dataTransfer.setData(h, e.key), p.dataTransfer.dropEffect = "move", u(!0);
  }
  function Pe() {
    u(!1);
  }
  ...
  function Se(p) {
    if (y(!1), p.dataTransfer.types.includes(h.toLowerCase())) {
      const W = p.dataTransfer.getData(h.toLowerCase());
...
function ui({
  ...
  for (let u = 0; u < t.length; u++) {
    const g = t[u], y = ge(g, i, {
      type: "HEADER"
    });
    y !== void 0 && (u += y - 1), d.push(/* @__PURE__ */ b(oi, {
      column: g,
      colSpan: y,
      rowIdx: e,
      isCellSelected: s === g.idx,
      onColumnResize: n,
      onColumnsReorder: r,
      onSortColumnsChange: a,
      sortColumns: o,
...
function bi({
  ...
  const {
    ...
    cellClass: v
  } = e, P = Ct(e, typeof v == "function" ? v(a) : v, r && wi, o && pi), E = kr(e, a);
  function k(S) {
    h({
      rowIdx: i,
      idx: e.idx
...
function xi({
  ...
  function x(T) {
    v == null || v(t), P == null || P(T);
  }
  e = Te(Cn, `rdg-row-${t % 2 === 0 ? "even" : "odd"}`, y == null ? void 0 : y(l, t), e, r === -1 && Gt);
  const S = [];
  for (let T = 0; T < w.length; T++) {
    ...
    L !== void 0 && (T += L - 1);
    const V = r === Y;
    V && h ? S.push(h) : S.push(/* @__PURE__ */ b(Ci, {
      column: z,
      colSpan: L,
      row: l,
      rowIdx: t,
...
const Ti = "rnvodz57-0-0-beta-47", Ei = `rdg ${Ti}`, Mi = "vlqv91k7-0-0-beta-47", Pi = `rdg-viewport-dragging ${Mi}`, Oi = "f1lsfrzw7-0-0-beta-47", Ni = "f1cte0lg7-0-0-beta-47", Fi = "s8wc6fl7-0-0-beta-47";
function Hi({
  column: e,
  colSpan: t,
  row: n,
...
function Yi({
  ...
  for (let d = 0; d < r.length; d++) {
    const u = r[d], g = ge(u, i, {
      type: "SUMMARY",
      row: n
    });
    g !== void 0 && (d += g - 1);
    const y = s === u.idx;
    h.push(/* @__PURE__ */ b(Li, {
      column: u,
      colSpan: g,
      row: n,
      rowIdx: e,
...
function Ai(e, t) {
  const {
    ...
    "aria-rowcount": Oe,
    "data-testid": Se
  } = e, R = At(), C = me ?? "grid", H = c ?? 35, p = l ?? (typeof H == "number" ? H : 35), W = w ?? (typeof H == "number" ? H : 35), _ = (L == null ? void 0 : L.renderRow) ?? (R == null ? void 0 : R.renderRow) ?? $r, j = (L == null ? void 0 : L.renderSortStatus) ?? (R == null ? void 0 : R.renderSortStatus) ?? Si, te = (L == null ? void 0 : L.renderCheckbox) ?? (R == null ? void 0 : R.renderCheckbox) ?? ma, le = (L == null ? void 0 : L.noRowsFallback) ?? (R == null ? void 0 : R.noRowsFallback), we = Y ?? !0, ie = oe ?? "ltr", [be, Ce] = Q(0), [Re, ye] = Q(0), [de, rt] = Q(() => /* @__PURE__ */ new Map()), [ze, Be] = Q(() => /* @__PURE__ */ new Map()), [Ue, Sn] = Q(null), [Rn, no] = Q(!1), [ot, ro] = Q(void 0), [Ne, In] = Q(null), Tn = J((f) => de.get(f.key) ?? ze.get(f.key) ?? f.width, [ze, de]), [je, En, Mn, oo] = Ha(), {
    columns: ee,
    colSpanColumns: Pn,
  ...
  }), at = (o == null ? void 0 : o.length) ?? 0, Ke = (a == null ? void 0 : a.length) ?? 0, Nn = at + Ke, Xe = $e + at, Bt = $e - 1, ue = -Xe, kt = ue + Bt, Ye = r.length + Ke - 1, [I, qe] = Q(() => ({
    idx: -1,
    rowIdx: ue - 1,
    mode: "SELECT"
  })), Ut = ve(I), Fn = ve(ot), Hn = ve(-1), Dt = ve(null), St = ve(!1), jt = C === "treegrid", Kt = $e * p, Ln = Nn * W, Rt = Mn - Kt - Ln, Xt = h != null && u != null, Wn = ie === "rtl", lo = Wn ? "ArrowRight" : "ArrowLeft", zn = Wn ? "ArrowLeft" : "ArrowRight", $n = Oe ?? $e + r.length + Nn, uo = B(() => ({
    renderCheckbox: te,
    renderSortStatus: j
  }), [te, j]), fo = B(() => {
    let f = !1, m = !1;
    if (i != null && h != null && h.size > 0) {
      for (const O of r)
        if (h.has(i(O)) ? f = !0 : m = !0, f && m) break;
    }
    return {
      isRowSelected: f && !m,
      isIndeterminate: f && m
  ...
  } = Fa(ee, Fe, io, je, En, de, ze, rt, Be, x), yo = jt ? -1 : 0, Ve = ee.length - 1, Vt = Jt(I), It = jn(I), po = p + qt + Ln + oo, bo = ce(wo), Co = ce(S), xo = ce(y), vo = ce(P), ko = ce(E), Do = ce(k), So = ce(To), Ro = ce(_n), Io = ce(Tt), Zt = ce(ct), Gn = ce(({
    idx: f,
    rowIdx: m
  }) => {
    ct({
  ...
  tt(() => {
    if (!Vt || nn(I, Ut.current)) {
      Ut.current = I;
      return;
    }
    Ut.current = I, I.idx === -1 && (Dt.current.focus({
      preventScroll: !0
    }), Nt(Dt.current));
  }), tt(() => {
    ...
    scrollToCell({
      ...
      const O = f !== void 0 && f > he && f < ee.length ? f : void 0, F = m !== void 0 && Ze(m) ? m : void 0;
      (O !== void 0 || F !== void 0) && In({
        idx: O,
        rowIdx: F
      });
    },
  ...
  function To(f) {
    ...
    const m = new Set(h);
    for (const O of r) {
      if ((d == null ? void 0 : d(O)) === !0) continue;
      const F = i(O);
      f.checked ? m.add(F) : m.delete(F);
    }
    u(m);
  }
  function _n(f) {
    ...
    if ((d == null ? void 0 : d(m)) === !0) return;
    const G = new Set(h), K = i(m), X = Hn.current, q = r.indexOf(m);
    if (Hn.current = q, O ? G.add(K) : G.delete(K), F && X !== -1 && X !== q && X < r.length) {
      const fe = ua(q - X);
      for (let se = X + fe; se !== q; se += fe) {
        const xe = r[se];
        (d == null ? void 0 : d(xe)) !== !0 && (O ? G.add(i(xe)) : G.delete(i(xe)));
      }
    }
    u(G);
  }
  ...
  function Tt(f, m, O) {
    if (typeof s != "function" || O === r[m]) return;
    const F = [...r];
    F[m] = O, s(F, {
      indexes: [m],
      column: f
  ...
  function Bn() {
    I.mode === "EDIT" && Tt(ee[I.idx], I.rowIdx, I.row);
  }
  function Po() {
    const {
      idx: f,
  ...
  function Jt({
    ...
    return m >= ue && m <= Ye && Un(f);
  }
  function Fo({
    idx: f,
    rowIdx: m
  }) {
    return Ze(m) && f >= 0 && f <= Ve;
  }
  function jn({
    idx: f,
    rowIdx: m
  ...
  function ct(f, m) {
    if (!Jt(f)) return;
    Bn();
    const O = r[f.rowIdx], F = nn(I, f);
    m && Et(f) ? qe({
      ...f,
      mode: "EDIT",
      row: O,
      originalRow: O
    }) : F ? Nt(er(je.current)) : (St.current = !0, qe({
      ...f,
      mode: "SELECT"
    })), M && !F && M({
      rowIdx: f.rowIdx,
  ...
  function Ho(f, m, O) {
    ...
    switch (f) {
      ...
      case "PageUp": {
        if (I.rowIdx === ue) return I;
        const X = Yn(G) + go(G) - Rt;
        return {
          idx: F,
          rowIdx: X > 0 ? An(X) : 0
        };
      ...
      case "PageDown": {
        if (I.rowIdx >= r.length) return I;
        const X = Yn(G) + Rt;
        return {
          idx: F,
          rowIdx: X < qt ? An(X) : r.length - 1
        };
      }
      default:
        return I;
  ...
  function Kn(f) {
    ...
    f.preventDefault();
    const G = Ht(f), K = Ho(m, G, O);
    if (nn(I, K)) return;
    const X = ia({
      moveUp: m === "ArrowUp",
      moveNext: m === zn || m === "Tab" && !O,
      columns: ee,
      colSpanColumns: Pn,
      rows: r,
      topSummaryRows: o,
  ...
  function Lo(f) {
    ...
    return (m < ot ? m < f && f <= ot : m > f && f >= ot) ? I.idx : void 0;
  }
  function Xn() {
  ...
  function zo(f) {
    if (I.rowIdx !== f || I.mode === "SELECT") return;
    const {
      idx: m,
      row: O
    } = I, F = ee[m], G = ge(F, he, {
      ...
      fe ? Ft(() => {
        Tt(F, I.rowIdx, q), K(se);
      }) : qe((xe) => ({
        ...xe,
        row: q
      }));
    };
    return r[I.rowIdx] !== I.originalRow && K(!1), /* @__PURE__ */ b(_a, {
      column: F,
      colSpan: G,
      row: O,
      rowIdx: f,
  ...
  function lt(f) {
    const m = I.idx === -1 ? void 0 : ee[I.idx];
    return m !== void 0 && I.rowIdx === f && !Fe.includes(m) ? I.idx > On ? [...Fe, m] : [...Fe.slice(0, he + 1), m, ...Fe.slice(he + 1)] : Fe;
  }
  function $o() {
    const f = [], {
      idx: m,
      rowIdx: O
    } = I, F = It && O < it ? it - 1 : it, G = It && O > st ? st + 1 : st;
    for (let K = F; K <= G; K++) {
      const X = K === it - 1 || K === st + 1, q = X ? O : K;
      let fe = Fe;
      const se = m === -1 ? void 0 : ee[m];
      se !== void 0 && (X ? fe = [se] : fe = lt(q));
      const xe = r[q], Yo = Xe + q + 1;
      let en = q, tn = !1;
      typeof i == "function" && (en = i(xe), tn = (h == null ? void 0 : h.has(en)) ?? !1), f.push(_(en, {
        "aria-rowindex": Xe + q + 1,
        "aria-selected": Xt ? tn : void 0,
        rowIdx: q,
        row: xe,
        viewportColumns: fe,
        isRowSelectionDisabled: (d == null ? void 0 : d(xe)) ?? !1,
        isRowSelected: tn,
        onCellClick: vo,
        ...
        rowClass: re,
        gridRowStart: Yo,
        copiedCellIdx: Ue !== null && Ue.row === xe ? ee.findIndex((Ao) => Ao.key === Ue.columnKey) : void 0,
        selectedCellIdx: O === q ? m : void 0,
        draggedOverCellIdx: Lo(q),
        setDraggedOverRowIdx: Rn ? Qt : void 0,
        lastFrozenColumnIndex: he,
        onRowChange: Io,
        selectCell: Zt,
        selectedCellEditor: zo(q)
      }));
    }
    return f;
  }
  (I.idx > Ve || I.rowIdx > Ye) && (qe({
    idx: -1,
    rowIdx: ue - 1,
    mode: "SELECT"
  }), Qt(void 0));
  ...
  const qn = I.idx === -1 && I.rowIdx !== ue - 1;
  return /* @__PURE__ */ ne("div", {
    role: C,
    "aria-label": Ee,
    "aria-labelledby": Me,
    "aria-describedby": Pe,
    "aria-multiselectable": Xt ? !0 : void 0,
    "aria-colcount": ee.length,
    "aria-rowcount": $n,
    className: Te(Ei, V, Rn && Pi),
    style: {
      ...A,
      scrollPaddingInlineStart: I.idx > he || (Ne == null ? void 0 : Ne.idx) !== void 0 ? `${co}px` : void 0,
      scrollPaddingBlock: Ze(I.rowIdx) || (Ne == null ? void 0 : Ne.rowIdx) !== void 0 ? `${Kt + at * W}px ${Ke * W}px` : void 0,
      gridTemplateColumns: mo,
      gridTemplateRows: Mt,
    ...
    children: [/* @__PURE__ */ ne(ka, {
      ...
      children: [/* @__PURE__ */ b(Ra, {
        ...
        children: /* @__PURE__ */ ne(Sa, {
          ...
          children: [Array.from({
            ...
            level: -Bt + m,
            columns: lt(ue + m),
            selectedCellIdx: I.rowIdx === ue + m ? I.idx : void 0,
            selectCell: Gn
          }, m)), /* @__PURE__ */ b(fi, {
            rowIdx: $e,
            columns: lt(kt),
            ...
            lastFrozenColumnIndex: he,
            selectedCellIdx: I.rowIdx === kt ? I.idx : void 0,
            selectCell: Gn,
            shouldFocusGrid: !Vt,
            direction: ie
          })]
        ...
        children: [o == null ? void 0 : o.map((f, m) => {
          const O = $e + 1 + m, F = kt + 1 + m, G = I.rowIdx === F, K = Kt + W * m;
          return /* @__PURE__ */ b(Jn, {
            ...
            lastFrozenColumnIndex: he,
            selectedCellIdx: G ? I.idx : void 0,
            isTop: !0,
            selectCell: Zt
          }, m);
        }), /* @__PURE__ */ b(Da, {
          value: Ro,
          children: $o()
        }), a == null ? void 0 : a.map((f, m) => {
          const O = Xe + r.length + m + 1, F = r.length + m, G = I.rowIdx === F, K = Rt > qt ? Mn - W * (a.length - m) : void 0, X = K === void 0 ? W * (a.length - 1 - m) : void 0;
          return /* @__PURE__ */ b(Jn, {
      ...
      ref: Dt,
      tabIndex: qn ? 0 : -1,
      className: Te(Oi, qn && [ii, he !== -1 && si], !Ze(I.rowIdx) && Ni),
      style: {
        gridRowStart: I.rowIdx + Xe + 1
      }
...
function Gi({
  ...
  return /* @__PURE__ */ b("div", {
    ...
    onClick: g ? u : void 0,
    onFocus: d,
    children: (!c || g) && ((y = a.renderGroupCell) == null ? void 0 : y.call(a, {
      groupKey: t,
      childRows: n,
      column: a,
      row: i,
...
function ji({
  ...
  return /* @__PURE__ */ b(Mr, {
    ...
    children: /* @__PURE__ */ b("div", {
      ...
      style: pn(s),
      ...h,
      children: r.map((y) => /* @__PURE__ */ b(_i, {
        id: t.id,
        groupKey: t.groupKey,
        childRows: t.childRows,
        isExpanded: t.isExpanded,
        isCellSelected: o === y.idx,
        column: y,
        row: t,
        groupColumnIndex: d,
        toggleGroup: l,
        isGroupByColumn: c.includes(y.key)
      }, y.key))
    })
  });
}
...
function Xi({
  ...
  var Pe, Oe, Se;
  const y = At(), v = (c == null ? void 0 : c.renderRow) ?? (y == null ? void 0 : y.renderRow) ?? $r, P = 1 + (((Pe = u.topSummaryRows) == null ? void 0 : Pe.length) ?? 0), E = u.direction === "rtl", k = E ? "ArrowRight" : "ArrowLeft", D = E ? "ArrowLeft" : "ArrowRight", M = ce(Ee), {
    columns: $,
    groupBy: x
  } = B(() => {
    const R = [...e].sort(({
      ...
      key: p
    }) => H === _e ? -1 : p === _e ? 1 : l.includes(H) ? l.includes(p) ? l.indexOf(H) - l.indexOf(p) : -1 : l.includes(p) ? 1 : 0), C = [];
    for (const [H, p] of R.entries())
      l.includes(p.key) && (C.push(p.key), R[H] = {
        ...p,
        frozen: !0,
        renderCell: () => null,
    ...
    const R = (C, [H, ...p], W) => {
      let _ = 0;
      const j = {};
      for (const [te, le] of Object.entries(w(C, H))) {
        const [we, ie] = p.length === 0 ? [le, le.length] : R(le, p, W + _ + 1);
        j[te] = {
          childRows: le,
          childGroups: we,
          startRowIndex: W + _
    ...
    const C = [], H = (W, _, j) => {
      ...
      Object.keys(W).forEach((te, le, we) => {
        const ie = _ !== void 0 ? `${_}__${te}` : te, be = h.has(ie), {
          childRows: Ce,
          childGroups: Re,
          startRowIndex: ye
        } = W[te], de = {
        ...
        C.push(de), R.add(de), be && H(Re, ie, j + 1);
      });
    };
    return H(S, void 0, 0), [C, p];
    function p(W) {
      return R.has(W);
    }
  }, [h, S, t]), Y = B(() => typeof n == "function" ? (R) => z(R) ? n({
    type: "GROUP",
    row: R
  }) : n({
    type: "ROW",
    ...
    const R = new Set(i);
    for (const C of T)
      z(C) && C.childRows.every((p) => i.has(r(p))) && R.add(C.id);
    return R;
  }, [z, r, i, T]);
  function re(R) {
    if (!s) return;
    ...
    for (const H of T) {
      const p = V(H);
      if (A != null && A.has(p) && !R.has(p))
        if (z(H))
          for (const W of H.childRows)
            C.delete(r(W));
        else
          C.delete(p);
      else if (!(A != null && A.has(p)) && R.has(p))
        if (z(H))
          for (const W of H.childRows)
            C.add(r(W));
        else
  ...
  function oe(R, C) {
    if (o == null || o(R, C), C.isGridDefaultPrevented() || R.mode === "EDIT") return;
    const {
      column: H,
      rowIdx: p,
      selectCell: W
    } = R, _ = (H == null ? void 0 : H.idx) ?? -1, j = T[p];
    if (z(j)) {
      if (_ === -1 && (C.key === k && j.isExpanded || C.key === D && !j.isExpanded) && (C.preventDefault(), C.preventGridDefault(), Ee(j.id)), _ === -1 && C.key === k && !j.isExpanded && j.level !== 0) {
        const te = L(j);
        te !== void 0 && (C.preventGridDefault(), W({
          idx: _,
          rowIdx: te[1]
        }));
      }
      Ht(C) && (C.keyCode === 67 || C.keyCode === 86) && C.preventGridDefault();
    }
  }
  function me(R, {
    indexes: C,
  ...
  function Me(R, {
    ...
    if (z(C)) {
      ...
      return /* @__PURE__ */ b(Ki, {
        ...Ce,
        "aria-rowindex": P + de + 1,
        row: C,
        groupBy: x,
        toggleGroup: M
      }, R);
    }
    let Re = Ce["aria-rowindex"];
    const ye = L(C);
    if (ye !== void 0) {
      const {
        startRowIndex: de,
        childRows: rt
      } = ye[0], ze = rt.indexOf(C);
      Re = de + P + ze + 2;
    }
    return v(R, {
      ...Ce,
  ...
  return /* @__PURE__ */ b(Yr, {
    ...u,
    role: "treegrid",
    "aria-rowcount": N + 1 + (((Oe = u.topSummaryRows) == null ? void 0 : Oe.length) ?? 0) + (((Se = u.bottomSummaryRows) == null ? void 0 : Se.length) ?? 0),
    ref: g,
    columns: $,
    rows: T,
    rowHeight: Y,
...
const Hl = /* @__PURE__ */ yn(Xi), Vi = "t7vyx3i7-0-0-beta-47", Zi = `rdg-text-editor ${Vi}`;
function Qi(e) {
...
const ns = ({
  ...
  const [r, o] = Q(n ?? []), a = B(() => r.length === 0 ? t : [...t].sort((s, c) => {
    for (const l of r) {
...
}, ds = 'button, a, input, select, textarea, [role="switch"], [role="checkbox"], [role="button"], [role="menuitem"]', us = (e, t, n) => Wt(e) || t === hs || t === Br ? !1 : !(n instanceof Element && n.closest(ds)), tr = De.div`
    display: flex;
    align-items: center;
    gap: 4px;
    width: 100%;
...
}, ys = (e, t = []) => Wt(e) ? as : t.includes(e.id) ? os : "", Ur = De(jo)`
  display: flex;
  flex-direction: column;
  align-items: flex-start;
  color: ${Z.gray800};
...
`, Ot = (e) => e.stopPropagation(), on = ({ children: e, ...t }) => /* @__PURE__ */ ne(Cs, { children: [
  Lr(t),
  e
] }), xs = (e) => (t) => {
  const { filters: n, setFilters: r } = ke(vn), o = B(() => n[e.key], [n, e]), a = J(
    (i) => {
      r({ ...n, [e.key]: i });
    },
    [e]
...
function ft(e) {
  return (t, n = {}) => {
    ...
    if (!a)
      return null;
    const i = a[0], s = r && e.parsePatterns[r] || e.parsePatterns[e.defaultParseWidth], c = Array.isArray(s) ? $s(s, (h) => h.test(i)) : (
...
function or(e, t) {
  const n = pe(e, t == null ? void 0 : t.in);
...
function pt(e, t) {
  var s, c, l, w;
  const n = vt(), r = (t == null ? void 0 : t.weekStartsOn) ?? ((c = (s = t == null ? void 0 : t.locale) == null ? void 0 : s.options) == null ? void 0 : c.weekStartsOn) ?? n.weekStartsOn ?? ((w = (l = n.locale) == null ? void 0 : l.options) == null ? void 0 : w.weekStartsOn) ?? 0, o = pe(e, t == null ? void 0 : t.in), a = o.getDay(), i = (a < r ? 7 : 0) + a - r;
...
function Kr(e, t) {
  const n = pe(e, t == null ? void 0 : t.in), r = n.getFullYear(), o = Le(n, 0);
...
function cc(e, t) {
  const n = pe(e, t == null ? void 0 : t.in), r = +zt(n) - +sc(n);
  return Math.round(r / jr) + 1;
}
function Xr(e, t) {
  var w, h, d, u;
  const n = pe(e, t == null ? void 0 : t.in), r = n.getFullYear(), o = vt(), a = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((h = (w = t == null ? void 0 : t.locale) == null ? void 0 : w.options) == null ? void 0 : h.firstWeekContainsDate) ?? o.firstWeekContainsDate ?? ((u = (d = o.locale) == null ? void 0 : d.options) == null ? void 0 : u.firstWeekContainsDate) ?? 1, i = Le((t == null ? void 0 : t.in) || e, 0);
...
function lc(e, t) {
  var s, c, l, w;
  const n = vt(), r = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((c = (s = t == null ? void 0 : t.locale) == null ? void 0 : s.options) == null ? void 0 : c.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((w = (l = n.locale) == null ? void 0 : l.options) == null ? void 0 : w.firstWeekContainsDate) ?? 1, o = Xr(e, t), a = Le((t == null ? void 0 : t.in) || e, 0);
  return a.setFullYear(o, 0, r), a.setHours(0, 0, 0, 0), pt(a, t);
}
function dc(e, t) {
  const n = pe(e, t == null ? void 0 : t.in), r = +pt(n, t) - +lc(n, t);
  return Math.round(r / jr) + 1;
}
function U(e, t) {
...
const cr = (e, t) => {
  ...
  return a.replace("{{date}}", cr(r, t)).replace("{{time}}", qr(o, t));
}, fc = {
  p: qr,
  P: uc
...
function Sc(e, t, n) {
  var w, h, d, u, g, y, v, P;
  const r = vt(), o = (n == null ? void 0 : n.locale) ?? r.locale ?? ec, a = (n == null ? void 0 : n.firstWeekContainsDate) ?? ((h = (w = n == null ? void 0 : n.locale) == null ? void 0 : w.options) == null ? void 0 : h.firstWeekContainsDate) ?? r.firstWeekContainsDate ?? ((u = (d = r.locale) == null ? void 0 : d.options) == null ? void 0 : u.firstWeekContainsDate) ?? 1, i = (n == null ? void 0 : n.weekStartsOn) ?? ((y = (g = n == null ? void 0 : n.locale) == null ? void 0 : g.options) == null ? void 0 : y.weekStartsOn) ?? r.weekStartsOn ?? ((P = (v = r.locale) == null ? void 0 : v.options) == null ? void 0 : P.weekStartsOn) ?? 0, s = pe(e, n == null ? void 0 : n.in);
  if (!Zr(s))
    throw new RangeError("Invalid time value");
  let c = t.match(xc).map((E) => {
    const k = E[0];
    if (k === "p" || k === "P") {
      const D = fc[k];
      return D(E, o.formatLong);
    }
    return E;
  }).join("").match(Cc).map((E) => {
    if (E === "''")
...
function mn(e, t) {
  const n = Pc(e, t), r = Qr(n[0], n[1] - 1, n[2], n[3] % 24, n[4], n[5], 0).getTime();
  let o = e.getTime();
  const a = o % 1e3;
...
function Jr(e, t = {}) {
  ...
  if (Object.prototype.toString.call(e) !== "[object String]")
    return /* @__PURE__ */ new Date(NaN);
  const r = jc(e), { year: o, restDateString: a } = Kc(r.date, n), i = Xc(a, o);
  if (i === null || isNaN(i.getTime()))
    return /* @__PURE__ */ new Date(NaN);
  if (i) {
    const s = i.getTime();
    let c = 0, l;
    if (r.time && (c = qc(r.time), c === null || isNaN(c)))
      return /* @__PURE__ */ new Date(NaN);
...
const rl = (e, t = "yyyy-MM-dd'T'HH:mm:ss'Z'", n = Intl.DateTimeFormat().resolvedOptions().timeZone) => {
...
}, Cr = (e) => e.trim().toLowerCase(), _t = Ie.createContext({
  columns: [],
  hiddenColumn: [],
  setHiddenColumn: () => {
  },
  ...
  const [i, s] = Ie.useState(0), [c, l] = Ie.useState([]);
  Ge(() => {
  ...
  const w = J((d) => {
    localStorage.setItem(a, JSON.stringify(d)), s((u) => u + 1), l(d);
  }, []), h = B(
...
`, fn = "rdg-cell-frozen-right", hn = (...e) => e.filter(Boolean).join(" "), il = ({
  ...
  const { enabled: i, hiddenColumn: s } = ke(_t), c = J((l) => {
    const w = () => {
      if (l.renderCell)
        return l.renderCell;
      if (l.type === et.DATE)
        return ({ row: u }) => {
          ...
          return rl(
            u[l.key],
            ((g = l.dateOptions) == null ? void 0 : g.formatDate) ?? to.DATE_WITH_TIME,
            (y = l.dateOptions) == null ? void 0 : y.timeZone
          );
        };
    }, h = () => l.renderHeaderCell ? l.renderHeaderCell : xs(l), d = {
      ...l,
      renderCell: w(),
      renderHeaderCell: h()
    };
  ...
  return B(() => {
    ...
    if (t && !n && l.push(gs(t)), n) {
      const w = (r ?? []).map((g) => g.id), h = w.length > 0 && w.every((g) => o == null ? void 0 : o.includes(g)), d = (g) => {
        const y = (o ?? []).filter((v) => !w.includes(v));
        return g ? [...y, ...w] : y;
      }, u = t ? 50 + mt : 50;
      l.push({
        ...dt,
        ...
        renderHeaderCell: () => /* @__PURE__ */ ne(tr, { children: [
          ...
          /* @__PURE__ */ b(
            ...
            {
              checked: h,
              onChange: (g, y) => a == null ? void 0 : a(d(y))
            }
          )
        ] }),
        renderCell: t ? (g) => {
          ...
          return /* @__PURE__ */ ne(tr, { children: [
            /* @__PURE__ */ b(Gr, { row: g.row, expandable: t }),
            (y = dt.renderCell) == null ? void 0 : y.call(dt, g)
          ] });
        } : dt.renderCell
      });
    }
...
function fl(e) {
  var t = e.loading, n = t === void 0 ? !0 : t, r = e.color, o = r === void 0 ? "#000000" : r, a = e.speedMultiplier, i = a === void 0 ? 1 : a, s = e.cssOverride, c = s === void 0 ? {} : s, l = e.size, w = l === void 0 ? 15 : l, h = e.margin, d = h === void 0 ? 2 : h, u = dl(e, ["loading", "color", "speedMultiplier", "cssOverride", "size", "margin"]), g = Yt({ display: "inherit" }, c), y = function(v) {
    return {
      backgroundColor: o,
      width: gn(w),
      height: gn(w),
      ...
      borderRadius: "100%",
      display: "inline-block",
      animation: "".concat(ul, " ").concat(0.75 / i, "s ").concat(v * 0.12 / i, "s infinite cubic-bezier(0.2, 0.68, 0.18, 1.08)"),
      animationFillMode: "both"
    };
  };
  return n ? Pt.createElement(
    "span",
    Yt({ style: g }, u),
    Pt.createElement("span", { style: y(1) }),
    Pt.createElement("span", { style: y(2) }),
    Pt.createElement("span", { style: y(3) })
  ) : null;
}
const hl = ({
  comparator: e,
...
`, Cl = Ie.memo(({ checked: e, onChange: t }) => {
  const n = J(
    (r, o) => {
  ...
  var R;
  const { gridKey: E } = ke(_t), { pageSize: k, currentPage: D, setCurrentPage: M, setPageSize: $ } = pl(
    ...
    selectedRows: s,
    onSelectedRowsChange: c
  }), S = B(() => x.map((C) => C.key).join("|"), [x]), N = B(
    () => x.some((C) => C.filterEnabled),
    [x]
  ), T = B(
    ...
    if (!T)
      return D;
    const C = Math.max(0, Math.ceil(Y.length / k) - 1);
    return Math.min(D, C);
  }, [T, D, k, Y.length]);
  Ge(() => {
    oe !== D && M(oe);
  }, [oe, D, M]);
  const me = B(() => T ? V.slice(oe * k, (oe + 1) * k) : V, [V, T, oe, k]), Ee = B(
    () => g ? ss(me, g.expandedIds) : me,
    [g, me]
  ), Me = B(
    () => g ? ms(x, g.renderDetail) : x,
    [g, x]
  ), Pe = J(
    (C, H) => {
      const p = ys(C, g == null ? void 0 : g.expandedIds);
      return p || (H === 0 ? "first-row" : H === n.length - 1 ? "last-row" : "");
    },
    [n, g == null ? void 0 : g.expandedIds]
  ), Oe = J(
    (C, H) => {
      v == null || v(C, H), !(!g || H.isGridDefaultPrevented()) && us(C.row, C.column.key, H.target) && _r(g, C.row.id);
    },
    [v, g]
  ), Se = !(d != null && d.remotePagination);
  return Ge(() => {
    if (!Se)
      return;
    const C = s == null ? void 0 : s.filter(
      (H) => n.some((p) => p.id === H)
    );
    (C == null ? void 0 : C.length) != (s == null ? void 0 : s.length) && (c == null || c(C ?? []));
  }, [n, s, Se]), /* @__PURE__ */ ne(es, { $pagination: !!(d != null && d.enabled), children: [
    /* @__PURE__ */ b("div", { children: /* @__PURE__ */ b(
      Yr,
      {
        selectedRows: s ? new Set(s) : void 0,
        onSelectedRowsChange: (C) => {
          c == null || c(Array.from(C));
        },
        rowKeyGetter: (C) => C.id,
        rows: Ee,
        ...
        onCellClick: Oe,
        enableVirtualization: Me.some((C) => C.frozenRight) ? !1 : void 0,
        ...P,
        rowHeight: g ? ws(
          y,
          xr,
        ...
        renderers: {
          renderCheckbox: (C) => /* @__PURE__ */ b(Cl, { ...C }),
    ...
    d != null && d.enabled ? /* @__PURE__ */ b(
      wl,
      {
        ...
        labels: d.labels ?? ((R = d.remotePagination) == null ? void 0 : R.labels)
      }
    ) : null,
  ...
  al,
  {
    ...
    localStorageKey: i,
    visibilityFeatureDisabledFor: o,
    children: /* @__PURE__ */ b(xl, { ...s, columns: n, filters: e, setFilters: t })
  }
) }), vl = De(Zo)`
    width: 100%;
    display: flex;
    ...
    gap: 12px;
`, zl = ({ IconComponent: e }) => {
  const { columns: t, hiddenColumn: n, setHiddenColumn: r } = ke(_t), o = Ie.useRef(null), [a, i] = Ie.useState(null), s = !!a, c = J(() => {
    i(o.current);
  }, []), l = J(() => {
    i(null);
  }, []), w = J(
    (h) => () => {
      const d = n.indexOf(h);
      r(
        d === -1 ? [...n, h] : n.filter((u) => u !== h)
      );
    },
    [n]
  );
  return /* @__PURE__ */ ne("div", { ref: o, children: [
    /* @__PURE__ */ b(e, { onClick: c }),
    /* @__PURE__ */ b(Vo, { id: "column-visibility-menu", anchorEl: a, open: s, onClose: l, children: t.map((h) => /* @__PURE__ */ ne(vl, { onClick: w(h.key), children: [
      /* @__PURE__ */ b(Dn, { checked: !n.includes(h.key) }),
      h.name
    ] }, h.key)) })
  ] });
};
